    ...
    function displayData(data) {
        ...
        const headerRow = `
            <div class="coin-row coin-heading">
                <div class="coin-cell" onclick="sortData('name')" style="cursor: pointer;"><span class="heading-hover">Coin Name</span></div>
                <div class="coin-cell" onclick="sortData('price')" style="cursor: pointer;"><span class="heading-hover">Price</span></div>
                <div class="coin-cell" onclick="sortData('high')" style="cursor: pointer;"><span class="heading-hover">24h High</span></div>
                <div class="coin-cell" onclick="sortData('low')" style="cursor: pointer;"><span class="heading-hover">24h Low</span></div>
                <div class="coin-cell" onclick="sortData('change')" style="cursor: pointer;"><span class="heading-hover">Price change</span></div>
